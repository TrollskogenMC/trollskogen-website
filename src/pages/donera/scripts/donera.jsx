      ...
      <InfoBoxInfo>
        <div className="group-list">
          <ul className="fc-light-grey">
            <li className="padding color-gold">/ci - Rensar ditt inventory</li>
            ...
            <li className="padding color-purple">
              /enderchest - öppna en enderchest utan att ha en i ditt inventory
            </li>
            <li className="padding color-purple">
            ...
            <li className="padding">
              ...
              discord-server och i chatten och du kan sälja 8 saker istället för
              2 i /ah.
            </li>
          </ul>
        </div>
  ...
  return (
    <div>
      ...
      <div className="donations-list">
        <div className="donate-content">{vipPlusContent()}</div>
